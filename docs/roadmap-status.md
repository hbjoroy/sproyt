...
| S-21 | Implemented and active | Production session boundary; encrypted session; refresh about 60 seconds before expiry; silent WebSocket cookie rotation; periodic provider revalidation; profile/logout shell; no simulated production identity; live Authentik identity and stable production session verified 2026-07-18 | Retain logout/revocation in the scheduled security drill |
| S-22 | Implemented and active | Responsive navigation/timeline/composer; production-accepted accessible mobile conversation/circle drawer; durable human-readable sender snapshots; circle-grouped channels; visible keyboard focus; bounded exponential reconnect; draft preservation; read markers/unread badges; production mobile drawer/channel/reconnect acceptance passed 2026-07-18 | Deploy sender-name snapshots and complete two-user usability sign-off |
