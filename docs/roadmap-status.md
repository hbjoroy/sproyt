...
| S-15 | Baseline implemented, sign-off pending | SLOs/runbook, Prometheus/Grafana resources, recovery CI, WebSocket capacity gate, and owner-authorized audited circle deletion | Portable export, production-sized load, owners, privacy/retention and rollout sign-off |
