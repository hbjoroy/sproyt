...
const chatFromWire = (event: WireChatEvent): ChatEvent => {
  ...
  if (event.type === "channel_created") return { type: event.type, channel_id: event.channel_id, created_by: event.created_by, source_channel_id: event.source_channel_id };
