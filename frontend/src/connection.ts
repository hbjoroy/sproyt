...
export function isClientCommand(value: unknown): value is ClientCommand {
  ...
  switch (value.type) {
    ...
    case "update_profile": return hasFields(payload, ["display_name"]) && isString(payload.display_name);
